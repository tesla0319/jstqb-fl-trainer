"""JSTQB Foundation Level 向けオリジナル問題データ（162問）。
...
SAMPLE_QUESTIONS: list[dict] = [
    ...
    {   # MD第151問
        ...
        "difficulty": 2,
        "question_text": (
            "あるホテル予約サービスの開発チームで、テスト実行ツールの導入を検討している。\n\n"
            "テスト実行ツールの主な機能として最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "テスト実行ツールはあらかじめ作成されたテストスクリプト"
            "（テストの手順・入力値・期待結果）を自動的に実行し、"
            "実際の結果と期待結果を比較してPass/Failを判定・記録するツールである。"
            "UIテスト自動化ツール（Selenium等）やAPIテストツール（Postman等）が代表例である。"
            "テスト計画の作成・テストケースの設計・欠陥の自動修正はテスト実行ツールの機能ではなく、"
            "それぞれ別の活動・ツールが担当する。"
        ),
        "trap_reason": None,
        "choices": [
            {"choice_text": "テスト担当者の代わりにテスト計画を作成する",                                                   "is_correct": False, "display_order": 1},
            {"choice_text": "テストスクリプトを実行し、実際の結果と期待結果を自動的に比較してテスト合否を判定する", "is_correct": True,  "display_order": 2},
            {"choice_text": "要求仕様書から自動的にテストケースを生成する",                                                   "is_correct": False, "display_order": 3},
            {"choice_text": "本番環境のバグを自動的に修正する",                                                               "is_correct": False, "display_order": 4},
        ],
    },
    ...
    {   # MD第152問
        ...
        "difficulty": 2,
        "question_text": (
            "あるECサイトの開発チームで、モデルベースドテスト（MBT）ツールの導入を検討している。\n\n"
            "モデルベースドテストの説明として最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "モデルベースドテスト（MBT）はシステムの期待する振る舞いを"
            "モデル（状態遷移図・アクティビティ図・デシジョンテーブル等）として記述し、"
            "そのモデルを解析してテストケースを自動生成する手法である。"
            "モデルの変更に追従してテストケースが自動更新される点が特徴であり、"
            "大規模・複雑なシステムのテスト設計効率化に有効である。"
            "コードの自動生成（選択肢Dの説明）はMDDやコードジェネレーターの機能であり、"
            "MBTとは別の概念である。"
        ),
        "trap_reason": None,
        "choices": [
            {"choice_text": "テスト担当者が手動でテストモデルを選択するツールである",                                                                       "is_correct": False, "display_order": 1},
            {"choice_text": "システムの振る舞いをモデル（状態遷移図・フローチャート等）として表現し、そのモデルからテストケースを自動生成する手法・ツールである", "is_correct": True,  "display_order": 2},
            {"choice_text": "モデルを使って本番環境のシステムを監視するツールである",                                                                       "is_correct": False, "display_order": 3},
            {"choice_text": "UMLモデルを使ってコードを自動生成するツールである",                                                                             "is_correct": False, "display_order": 4},
        ],
    },
    ...
    {   # MD第153問
        ...
        "difficulty": 2,
        "question_text": (
            "あるネット銀行の開発チームで、テストツールの選定プロセスについて議論した。\n\n"
            "ツール選定において最初に行うべき活動として最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "ツール選定は「課題・ニーズの分析」から始めることが重要である。"
            "具体的には「どのテスト活動を効率化したいか」「現在のプロセスのどこにボトルネックがあるか」"
            "「チームのスキルレベル」「既存環境との統合要件」「予算・ライセンス形態」などを事前に整理する。"
            "この要件定義なしにツールを選ぶと、導入後に「期待した機能がない」"
            "「既存ツールと連携できない」「チームが使いこなせない」という問題が発生しやすい。"
        ),
        "trap_reason": None,
        "choices": [
            {"choice_text": "最も有名なツールを選んで即座に全チームに展開する",                                           "is_correct": False, "display_order": 1},
            {"choice_text": "現在のテストプロセスの課題・ニーズ・制約を分析し、ツールに求める要件を定義する", "is_correct": True,  "display_order": 2},
            {"choice_text": "競合する全ツールを購入して試す",                                                               "is_correct": False, "display_order": 3},
            {"choice_text": "ツールの選定はベンダーに一任する",                                                             "is_correct": False, "display_order": 4},
        ],
    },
    ...
    {   # MD第154問
        ...
        "difficulty": 2,
        "question_text": (
            "あるフードデリバリーサービスの開発チームで、テスト自動化ツールを6か月間使用した後、"
            "「期待した効果が出ていない」という声が上がった。\n\n"
            "自動化の効果が出にくい原因として最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "テスト自動化で効果が出にくい主な原因として以下が挙げられる。"
            "仕様が頻繁に変わるテストを自動化するとスクリプトの保守コストが高くなる。"
            "人間の判断・感性が必要なテスト（ユーザビリティ評価・探索的テスト）を自動化しようとしても"
            "有効な結果が得られない。"
            "スクリプトの設計が悪く変更に弱い構造になっている。"
            "また「自動化すれば手がかからなくなる」という誤解から保守工数を計画していない場合も多い。"
            "自動化はあくまで適切な対象を選んで実施することが重要である。"
        ),
        "trap_reason": None,
        "choices": [
    ...
    {   # MD第155問
        ...
        "difficulty": 2,
        "question_text": (
            "あるECサイトのテストチームで、テスト管理ツールとバージョン管理システムを連携させた。\n\n"
            "この連携によって実現できることとして最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "テスト管理ツールとバージョン管理システム（GitなどのVCS）を連携することで"
            "「どのバージョンのコードに対してどのテストを実施し、何件の欠陥が発見されたか」という"
            "トレーサビリティを確保できる。"
            "これにより「特定のバグが何のコード変更で混入したか」"
            "「リリースバージョンに対するテスト実施状況」の追跡が可能になり、"
            "品質の可視化と再現性の確保に役立つ。"
        ),
        "trap_reason": None,
        "choices": [
            {"choice_text": "テストケースが自動的に合格になる",                                                                                                        "is_correct": False, "display_order": 1},
            {"choice_text": "テストケース・テスト結果・欠陥と、対応するソースコードのバージョン・変更履歴のトレーサビリティを確保できる", "is_correct": True,  "display_order": 2},
            {"choice_text": "バグを自動的に修正できる",                                                                                                                "is_correct": False, "display_order": 3},
            {"choice_text": "テスト担当者がソースコードを直接修正できるようになる",                                                                                    "is_correct": False, "display_order": 4},
        ],
    },
    ...
    {   # MD第156問
        ...
        "difficulty": 2,
        "question_text": (
            "あるネット銀行のプロジェクトで、ツール導入後に「ツールが正しいとは限らない」"
            "という議論が起きた。\n\n"
            "ツールの出力を盲目的に信頼するリスクとして最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "ツール（静的解析ツール・テスト実行ツール・カバレッジツール等）はあくまで支援手段であり、"
            "出力結果には誤検知（フォールスポジティブ）や見逃し（フォールスネガティブ）が存在する可能性がある。"
            "ツールの出力を盲目的に信頼すると"
            "「警告が多すぎて重要な問題を見逃す（アラート疲れ）」"
            "「ツールが検出しない欠陥が見落とされる」"
            "「誤検知への対応で工数を無駄にする」などのリスクがある。"
            "ツールの出力はテスト担当者が判断・検証する材料として活用することが重要である。"
        ),
        "trap_reason": None,
        "choices": [
            {"choice_text": "ツールの出力は常に正確であるため、リスクは存在しない",                                                                                                        "is_correct": False, "display_order": 1},
            {"choice_text": "ツールも誤検知・見逃しを起こす可能性があり、ツールの出力を検証なしに信頼すると本来の問題を見落としたり、不要な対応に工数をかけるリスクがある", "is_correct": True,  "display_order": 2},
            {"choice_text": "ツールを使うとテスト担当者のスキルが下がるため、ツール自体を禁止すべきである",                                                                            "is_correct": False, "display_order": 3},
            {"choice_text": "ツールのリスクは導入コストのみであり、使用開始後のリスクはない",                                                                                          "is_correct": False, "display_order": 4},
        ],
    },
    ...
    {   # MD第157問
        ...
        "question_text": (
            "あるホテル予約サービスのプロジェクトで、"
            "テスト環境の構築・管理を自動化するツールの導入を検討している。\n\n"
            "テスト環境管理の自動化がもたらす主なメリットとして最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "テスト環境の手動管理では「設定のミス」「前回テストの設定が残っている」"
            "「本番と異なるバージョンのミドルウェアが入っている」などの環境差異が"
            "欠陥の見落としや誤検知の原因になる。"
            "IaC（Infrastructure as Code）やコンテナ技術を活用した環境自動化により、"
            "テストのたびに一貫した環境を自動構築・リセットできるため、"
            "テストの再現性と信頼性が向上する。"
            "完全な本番同等環境を低コストで実現することや速度の保証はツールによって異なり、"
            "一般的な主張としては誇張になる。"
        ),
        "trap_reason": None,
        "choices": [
            {"choice_text": "テスト環境の自動化により、テスト担当者の雇用が不要になる",                                                               "is_correct": False, "display_order": 1},
            {"choice_text": "環境のセットアップ・リセット・再現を一貫して自動化することで、環境差異による欠陥の混入を防ぎ、テストの再現性を高める", "is_correct": True,  "display_order": 2},
            {"choice_text": "本番環境と完全に同一のテスト環境を低コストで用意できる",                                                                 "is_correct": False, "display_order": 3},
            {"choice_text": "テスト環境の自動化により、テストの実行速度が10倍以上向上する",                                                           "is_correct": False, "display_order": 4},
        ],
    },
    ...
    {   # MD第158問
        ...
        "difficulty": 2,
        "question_text": (
            "あるECサイトの開発チームで、APIテストツールを導入した。\n\n"
            "APIテストツールを使用することの主なメリットとして最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "APIテストツール（Postman・REST Assuredなど）はHTTPリクエストを直接送信し、"
            "レスポンスの内容（ステータスコード・ボディ・ヘッダー）を確認するツールである。"
            "UIを経由しないため「UIの変更によるテストの壊れ」が発生せず、"
            "UIテストより安定して実行できる。"
            "またUIが完成する前の開発段階からAPIレベルのテストを開始できるため、"
            "シフトレフトの実践にも貢献する。"
            "テストピラミッドの観点では、UIテストより下位の層に位置し、"
            "より多くのケースを効率的に確認できる。"
        ),
        "trap_reason": None,
        "choices": [
            {"choice_text": "UIを操作せずにAPIレベルでリクエスト・レスポンスを直接確認でき、UIの変更に影響されない安定したテストが実現できる", "is_correct": True,  "display_order": 1},
            {"choice_text": "APIテストツールはUIテストツールと同じであり、区別は不要である",                                                         "is_correct": False, "display_order": 2},
            {"choice_text": "APIテストツールを導入すると、データベースの設計が自動的に最適化される",                                               "is_correct": False, "display_order": 3},
            {"choice_text": "APIテストツールはセキュリティテストの代わりに使用できる",                                                               "is_correct": False, "display_order": 4},
        ],
    },
    ...
    {   # MD第159問
        ...
        "difficulty": 2,
        "question_text": (
            "あるネット銀行の開発チームで、セキュリティテストツールの種類について整理している。\n\n"
            "「Webアプリケーションの既知の脆弱性パターン（SQLインジェクション・XSSなど）を"
            "自動的にスキャンするツール」として最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "脆弱性スキャナー（DASTツール）はWebアプリケーションに対して"
            "既知の攻撃パターン（SQLインジェクション・クロスサイトスクリプティング・認証バイパス等）を"
            "自動的に試行し、脆弱性の有無を検出するツールである。"
            "実際にアプリケーションを動作させながらテストする点でDynamic（動的）に分類される。"
            "これに対してコードを解析して脆弱性パターンを検出する"
            "SAST（静的アプリケーションセキュリティテスト）ツールもある。"
            "負荷テストツールは性能測定、カバレッジツールはコード実行率計測に使用する。"
        ),
        "trap_reason": None,
        "choices": [
            {"choice_text": "負荷テストツール",                                                 "is_correct": False, "display_order": 1},
            {"choice_text": "脆弱性スキャナー（DAST：動的アプリケーションセキュリティテストツール）", "is_correct": True,  "display_order": 2},
            {"choice_text": "カバレッジ計測ツール",                                             "is_correct": False, "display_order": 3},
            {"choice_text": "テスト管理ツール",                                                 "is_correct": False, "display_order": 4},
        ],
    },
    ...
    {   # MD第160問
        ...
        "question_text": (
            "あるフードデリバリーサービスの開発チームで、"
            "テストツールの導入プロジェクトを振り返った。\n\n"
            "ツール導入が失敗しやすい要因として最も適切なものはどれか。"
        ),
        "multi_select_count": 1,
        "explanation": (
            "ツール導入が失敗する主な要因として、JSTQB FL v4.0 では以下を挙げている。"
            "「ツールをチームのプロセスに合わせるのではなく、ツールの制約に合わせてプロセスを変えようとする」"
            "「導入の目的・期待効果をステークホルダーと合意しないまま展開する」"
